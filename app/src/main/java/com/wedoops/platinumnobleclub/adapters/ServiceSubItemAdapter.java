...
public class ServiceSubItemAdapter extends RecyclerView.Adapter<ServiceSubItemAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        Glide.with(myViewHolder.imageView.getContext()).load(mData.get(i).getSubServiceImagePath()).placeholder(R.drawable.loading).timeout(10000).into(myViewHolder.imageView);
