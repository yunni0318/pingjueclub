...
//        Double d_eventprice = eded_all.get(0).getEventPrice();
        ...
        Glide.with(this).load(eded_all.get(0).getEventBannerImagePath()).apply(new RequestOptions().transform(new RoundedCornersTransformation(100, 0, RoundedCornersTransformation.CornerType.TOP))).timeout(10000).into(imageview_eventdetail);
